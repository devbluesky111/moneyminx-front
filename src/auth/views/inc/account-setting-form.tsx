...
const AccountSettingForm: React.FC<Props> = ({ currentAccount, handleReload, closeSidebar }) => {
  ...
  const isFromAccount = pathname.includes('/account-details/');
        ...
        return (
          <div className='bg-white credentials-wrapper account-setting'>
            <div className='credentials-content'>
              {isFromAccount && <div className='close-icon' onClick={closeSidebar}>✕</div>}
