  ...
  <Modal {...settingModal.props} title='' canBeClosed>
    <div className='modal-wrapper chart-setting-modal modal-md mm-setting-modal'>
      <div className="mm-setting-modal__title">
          ...
          <Card.Body>
            ...
            <div className="d-flex justify-content-between">
              ...
              <span className='mm-switch-block'>
                <input value='true' type='radio' name='profileEnabled' className='mm-switch-input'
                  aria-checked='true' />
                <label className='mm-switch mt-md-0 mt-3' role='button' />
              </span>
            </div>
            <Form.Control className='mm-url-link' size="lg" type="text"
        ...
        <div>
          <div className='mm-setting-modal__sub-title'>
            Allocation style
          </div>
          <p>Which allocation style do you want displayed?</p>

          <div className='mm-plan-radios m-auto mt-2 text-nowrap'>
            <input type='radio' id='mm-allocation-type-modal' value='type'
              name='mm-radio-time-interval' aria-checked='true' />
            <label className='labels' htmlFor='mm-allocation-type-modal'>
              Type
            </label>
            <input type='radio' id='mm-allocation-asset-modal' value='annually'
              name='mm-radio-time-interval' aria-checked='false' />
            <label className='labels' htmlFor='mm-allocation-asset-modal'>
              Asset Class
            </label>
            <input type='radio' id='mm-allocation-country-modal' value='country'
              name='mm-radio-time-interval' aria-checked='false' />
            <label className='labels' htmlFor='mm-allocation-country-modal'>
              Location
            </label>
            <input type='radio' id='mm-allocation-risk-modal' value='risk'
              name='mm-radio-time-interval' aria-checked='false' />
