...
export { default as SubscriptionReview } from 'auth/views/subscription-review';
...
export { default as StripeFailure } from 'setting/pages/stripe-checkout-failure';

export { default as Networth } from 'networth/views/networth';
